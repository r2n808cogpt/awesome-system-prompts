...
An opinionated list of awesome system prompts for various AI models.
...
- [Prompt](docs/assets/bolt/prompt-2025.txt)

### [Claude](https://claude.ai)

- [Prompt Sonnet 3.7](docs/assets/claude/sonnet-3.7-2025.txt)
...
- [Grok2](docs/assets/grok/grok2.txt)
- [Grok3-0330](docs/assets/grok/grok3-0330.j2)
- [Grok3-With-Deep-Search](docs/assets/grok/grok3-with-deep-search.txt)
- [Grok3](docs/assets/grok/grok3.txt)
...
- [Prompt](docs/assets/lovable/prompt-2025.txt)

### [Manus](https://www.manus.io)

- [Agent-Loop](docs/assets/manus/agent-loop.txt)
- [Module](docs/assets/manus/module.txt)
- [Prompt](docs/assets/manus/prompt.txt)
- [Tools](docs/assets/manus/tools.json)
...
- [GPT 4.5](docs/assets/openai/4-5.txt)
- [GPT 4o](docs/assets/openai/4o.txt)
- [Dalle](docs/assets/openai/dalle.txt)
